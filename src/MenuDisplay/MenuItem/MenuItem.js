...
class MenuItem extends Component {
    ...
    render() {
        ...
        let img= <img className={styles.SmallImg} alt={this.props.name} src={this.props.img}></img>;

        if(this.state.hovered) {
            orderLabel= <h2 className={styles.Label}>ORDER <i class="fas fa-arrow-right"></i></h2>;

            img= <img className={styles.BigImg} alt={this.props.name} src={this.props.img}></img>;
        };
